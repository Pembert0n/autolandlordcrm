...
def on_next_page_click():
    ...
    back_to_main_page.grid(row=2, column=0, padx=20, pady=20)  # Die Schaltfläche back_to_main_page einblenden
...
def on_back_to_main_page_click():
    ...
    back_to_main_page.grid_forget()  # Die Schaltfläche back_to_main_page ausblenden
    next_test_page.grid(row=2, column=0, padx=20, pady=20)  # Die Schaltfläche next_test_page einblenden
...
back_to_main_page = tk.Button(root, text="Back to Main Page", command=on_back_to_main_page_click)
